...
// CONCATENATED MODULE: ./src/plugin/constant.js
var resourceType = {
  css: 'CSS',
  js: 'JS',
  img: 'IMAGE',
...
function getType(url) {
  ...
  for (var _i = 0, _Object$entries = Object.entries(supportFormat); _i < _Object$entries.length; _i++) {
...
function checkType() {
  ...
  var formatArr = arguments.length > 1 ? arguments[1] : undefined;
  var regStr = '';
  formatArr.forEach(function (item, idx) {
  ...
  if (url) {
    var reg = new RegExp("[".concat(regStr, "]"), 'i');
...
var plugin_Load = function Load() {
  var out = {};
  var loadedRes = {};

  out.load = function load(_ref) {
    var srcList = _ref.srcList,
        percentCb = _ref.percentCb,
        completeCb = _ref.completeCb;
    var state = new State(srcList);
    loadRes(srcList, state);
    startLoading(state, completeCb, percentCb);
  };

  function State(srcList) {
...
/* harmony default export */ var src_plugin = (plugin_Load());
